...
-- Dumping data for table larabuilder.migrations: ~28 rows (approximately)
...
-- Dumping data for table larabuilder.settings: ~16 rows (approximately)
...
INSERT INTO `settings` (`id`, `name`, `value`, `created_at`, `updated_at`) VALUES
	...
	(7, 'hero_title', 'Start Your Business With LaraBuilder', NULL, NULL),
	(8, 'hero_sub_title', 'A +400 professionally designed blocks allowing you to start building sites and pages instantly with Easy to use drag & drop builder!', NULL, NULL),
...
-- Dumping data for table larabuilder.users: ~3 rows (approximately)
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `user_type`, `role_id`, `profile_picture`, `status`, `language`, `company_id`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'larabuilder', 'mohammed.hudair@gmail.com', '2022-05-25 08:25:53', '$2y$10$aJsJBdj2hPYXpslBmguo0uJNhBvsC9WGF57wIH4X9ieRpIcthBwM6', 'admin', NULL, 'default.png', 1, NULL, NULL, NULL, '2022-05-25 08:25:53', '2022-05-25 08:25:53'),
